...
![title](https://d27n7fycrsusaz.cloudfront.net/new+workspace.PNG)
    ...
    **Create a project** inside your workspace, enter that project and add some users to it using the same procedure you used to add users to the workspace.
    ...
    Because most data science projects are multifaceted, projects contain subprojects where the work actually occurs. **Create a subproject** and we're ready to get to work.
