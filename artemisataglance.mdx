...
<Accordion title="Place instances on the network">
  ...
  <Frame caption="This is where you can create the details of your instance — note that you designate the 'underlying resource' by pasting in the ID number from the resource you're making an instance of">
