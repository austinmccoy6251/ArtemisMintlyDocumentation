...
![title]([/path/image.jpg](https://d27n7fycrsusaz.cloudfront.net/Comparison+Graphic++(60).png))
## Artemis Structure
...
![title]([/path/image.jpg](https://d27n7fycrsusaz.cloudfront.net/network+diagram+artemis+structure.PNG))
##Getting Started
...
<AccordionGroup>
  ...
  The first thing we need to do here is make sure there are members in our organization. These people can subsequently be added to our first workspace. The way we add members to an org is by clicking the "Settings" tab on the left side toolbar, clicking "Users" when it appears then opting to "Add User."
    ![title]([/path/image.jpg](https://d27n7fycrsusaz.cloudfront.net/new+users.PNG)
...
![title]([/path/image.jpg](https://d27n7fycrsusaz.cloudfront.net/add+workspace.PNG)
