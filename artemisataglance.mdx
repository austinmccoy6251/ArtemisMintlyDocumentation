...
Next, **create a workspace** by pressing the green “New Workspace” button on the home page. Name your workspace when prompted then click it when it appears. 
  ...
  <img src="https://d27n7fycrsusaz.cloudfront.net/new+project+create.PNG" />
    ...
    Because most data science projects are multifaceted, projects contain subprojects where the work actually occurs. Finally, **create a subproject** as seen below. Subprojects are automatically availalbe to the same userset that has access to the main project.
