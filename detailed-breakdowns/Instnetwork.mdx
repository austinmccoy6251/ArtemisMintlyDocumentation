...
## Network
Each Subproject has its own set of Modules, accessible via the left-hand toolbar. You can have multiple Modules per Subproject. Each Module contains a Network you can use to diagram part of your work.
...
## Creating Instancess
Instances are created on the Network and show when and how Resources are deployed as part of your work. Here's a video illustrating the process: 
...
As soon as you click, a modal like the one below will appear. The one field that’s important to take note of at this point is the “underlying resource” box. Whichever resource you’re trying to make an Instance of, copy its resource ID and paste it here.
