...
<Frame caption="This is what the experiment modal looks like">
  <img src="https://d27n7fycrsusaz.cloudfront.net/exp+modal.PNG" />
</Frame>

## Creating Instancess
Instances are created on the Experiment Network show when and how resources are deployed as part of your work. Here's a video illustrating the process: 
...
First, open the experiment you're working in and press the second tab in the modal to call up the network.
