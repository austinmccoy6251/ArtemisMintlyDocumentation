...
<iframe src="<div>
        ...
        <div class="sl-embed" style="position:relative;padding-bottom:calc(68.99% + 27px);width:100%;height:0;transform:scale(1)">
          <iframe class="sl-demo" src="https://app.storylane.io/demo/pqoyksxxdl4a" allow="fullscreen; camera; microphone" style="position:absolute;top:0;left:0;width:100%;height:100%;border:none;"></iframe>
        </div>
      </div>"> </iframe>
